<template>
  <ContentWrap>
    ...
    <el-form
      ...
      label-width="100px"
    >
      <el-form-item label="提交人单位" prop="userDeptId">
        <el-input
      ...
      <el-form-item label="报险人手机" prop="userMobile">
        <el-input
      ...
      <el-form-item label="使用单位" prop="endusageDeptId">
        <el-select v-model="queryParams.endusageDeptId" placeholder="请选择使用单位">
          <el-option
      ...
      <el-form-item label="维保单位" prop="maintainDeptId">
        <el-select v-model="queryParams.maintainDeptId" placeholder="请选择维保单位">
          <el-option
...
const getList = async () => {
  loading.value = true
  try {
    const data = await ReparationPartApi.getAllReparationPartPage(queryParams)
